...
const services = [
  ...
  },
  {
    ...
    description:
      "From custom stickers for branding, storefronts and vehicles to detailed short-run digital printing, we have the tools and creativity to meet your design needs quickly and professionally.",
    features: ["Vehicle decals", "Window graphics", "Digital prints", "Weather resistant"],
  },
]
          ...
          >
            ...
            <div className="relative h-48 sm:h-56 overflow-hidden">
              ...
              <div className="absolute top-4 left-4 right-4">
                <div className="bg-purple/30 backdrop-blur-[2px] rounded-lg px-3 py-2">
                  <h3 className="text-sm sm:text-sm font-semibold text-white leading-tight">
